...
def stream_to_kafka(
    ...
    print(payload)
    # response = requests.post(f"{api_url}/topics/{topic_name}", json=payload, headers=headers)
    ...
    for i in range(500):
        ...
        with engine.connect() as connection:
            ...
            for row in pin_selected_row:
                ...
                print('Pin row:')
                stream_to_kafka(cleaned_pin_result)
            ...
            for row in geo_selected_row:
                ...
                print('Geo row:')
                stream_to_kafka(cleaned_geo_result)
            ...
            for row in user_selected_row:
                ...
                print('User row')
                stream_to_kafka(cleaned_user_result)
        break
...
if __name__ == "__main__":
    ...
    run_infinite_post_data_loop(engine)

    api_creds = load_yaml('API_invoke_url.yaml')
    api_invoke_url = api_creds['invoke_url']
    print(api_invoke_url)